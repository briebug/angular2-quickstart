    ...
    return {
        ...
        execute: function() {
            exports_1("HEROES", HEROES = [
                ...
                { "id": 17, "name": "Dynama", power: null, alterEgo: null },
                { "id": 18, "name": "Dr IQ", power: null, alterEgo: null },
                { "id": 19, "name": "Magma", power: null, alterEgo: null },
                { "id": 20, "name": "Tornado", power: null, alterEgo: null }
            ]);
        }
    }
});
